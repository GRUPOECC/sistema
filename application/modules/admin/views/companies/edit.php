    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/companies/edit/'.$id); ?>
                    <div class="box-body">
                         <div>
                             (*) Campo Obligatorio 
                             </br>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="rif" value="<?php echo $company->rif; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="codigo" value="<?php echo $company->cod_interno; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="razon" value="<?php echo $company->razon_social; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <textarea type="text" name="direccion" value="<?php echo $company->direccion; ?>" class="form-control"> <?php echo $company->direccion; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="telefono" value="<?php echo $company->telefono; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="extension" value="<?php echo $company->extension; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
