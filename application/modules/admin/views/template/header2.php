...
<html>
                        ...
                        <li class="dropdown tasks-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php 
                                    if(!empty($task_alert))
                                    {
                                        echo '<span class="label label-danger">'.count($task_alert).'</span>'; 
                                    }
                                ?>
                                
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header"><?php echo count($task_alert) ?> <?php echo lang('task_comming_in_next'); ?>  <?php echo $notification->task_alert;?>  <?php echo lang('days'); ?>.</li>
                               <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                    <?php 
                                    foreach ($task_alert as $new){
                                    echo'   <li>
                                            <a href="'.site_url('admin/tasks/view_task/'.$new->id).'" style="color:#666666">
                                                <i class="fa fa-legal"></i> Case NO - '.$new->task_no.' On '.date_convert($new->next_date).'</a>
                                       </li>
                                    ';
                                    }
                                    ?>
                                ...
                                <li class="footer">
                                    <a href="<?php echo site_url('admin/tasks/view_all') ?>"><?php echo lang('view_all'); ?> </a>
                                </li>
                            </ul>
                      </li>
                        <!-- Task Alert End -->
                        ...
                        <li class="dropdown tasks-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<?php 
									...
									{
										echo '<span class="label label-danger">'.count($message_alert).'</span>'; 
									}
								?>
								
							</a>
                            <ul class="dropdown-menu">
                                <li class="header"><?php echo count($message_alert) ?> <?php echo lang('message_comming_in_next'); ?>  <?php echo $notification->message_alert;?>  <?php echo lang('days'); ?>.</li>
                               <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
									<?php 
									foreach ($message_alert as $new){
									echo'	<li>
                                            <a href="'.site_url('admin/messages/view_message/'.$new->id).'" style="color:#666666">
                                                <i class="fa fa-legal"></i> Message NO - '.$new->message_no.' On '.date_convert($new->next_date).'</a>
                                       </li>
									';
									}
									?>
                                ...
                                <li class="footer">
                                    <a href="<?php echo site_url('admin/messages/view_all') ?>"><?php echo lang('view_all'); ?> </a>
                                </li>
                            </ul>
                      </li>
                        <!-- Message Alert End -->
   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<?php foreach($actions as $action){ 
			 if($action->action=='companies' || $action->action=='user_role' || $action->action=='departments' || $action->action=='clients' || $action->action=='employees' ||  
