				...
				<div class="box-body">
						...
						<div class="tabbable">
										...
										<ul class="nav nav-tabs">
											...
											<li><a href="#4" data-toggle="tab"><?php echo lang('modules_settings');?></a></li>
										</ul>
									<div class="tab-content">
		<!-- aca empieza el contenedor de los formularios -->
			...
			<?php $tz = DateTimeZone::listIdentifiers(DateTimeZone::ALL); 
							...
							<!-- INICIO DIV HR SETTINGS -->
										...
										<!-- INICIO DIV SMTP SETTINGS -->
											...
											</div>	<!-- FIN DIV MODULES SETTINGS -->

									</div><!-- este div de cierre del tab content -->
