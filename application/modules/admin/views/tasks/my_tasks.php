     ...
     if (isset($_POST["task_check"])){
        ...
        $cantidad = count($delete); 
         ...
         if (isset($_POST["submit"])) 
           header('Location: '.site_url('admin/tasks/deleteMytask/').'/'.$conjunto);    
      }
									...
									<?php } ?>	
									  <?php if(check_user_role(114)==1){?>  
                                        ...
                                        <?php if(check_user_role(116)==1){?>    
                                         <?php if($new->progress!=100){?>
                                         <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/tasks/deleteMytask/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"> </i> <?php echo lang('delete')?></a>
                                         <?php } ?>
                                        <?php } ?>
