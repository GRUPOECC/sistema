...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/visitors/add/'); ?>
                    <div class="box-body">
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;"><?php echo lang('Visitor');?></label>
									   <select name="contact_id" class="form-control chzn">
											<option value="">--<?php echo lang('select_visitor');?>--</option>
								...
								<div class="row">
                                        <div class="col-md-4">
                                    <label for="name" style="clear:both;"><?php echo lang('who_visit');?></label>
									   <select name="user_id" class="form-control chzn">
											<option value="">--<?php echo lang('select_who_visit');?>--</option>
											<?php foreach($users as $new) {
													$sel = "";
													if(set_select('user_id', $new->id)) $sel = "selected='selected'";
													echo '<option value="'.$new->id.'" '.$sel.'>'.$new->name.'</option>';
												}
											?>
										</select>
