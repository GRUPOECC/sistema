...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/visitors/edit/'.$id); ?>
                    <div class="box-body">
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;"> <?php echo lang('title');?></label>
									<input type="text" name="title" value="<?php echo $visitor->title;?>" class="form-control">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <label for="name" style="clear:both;"><?php echo lang('contact');?></label>
									   <select name="contact_id" class="form-control chzn">
											...
											<?php foreach($contacts as $new) {
													$sel = "";
													if($new->id==$visitor->contact_id) $sel = "selected='selected'";
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<textarea name="motive"class="form-control"><?php echo $visitor->motive;?></textarea>
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="date_time"class="form-control datetimepicker" value="<?php echo $visitor->date_time;?>">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<textarea name="notes" class="form-control"><?php echo $visitor->notes;?></textarea>
                                </div>
                            </div>
                        </div>
