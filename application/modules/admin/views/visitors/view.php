...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/visitors')?>"><?php echo lang('visitors');?></a></li>
                ...
                <!-- form start -->
                        ...
                        <div class="form-group">
                        	...
                        	<div class="row">
								...
								<div class="col-md-4">	
									<?php foreach($contacts as $new) {
											$sel = "";
											if($new->id==$visitor->contact_id) echo $new->name;
										}
						 ...
						 <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">	
									<?php echo date_time_convert($visitor->date_time_in);?>
                                </div>
                            </div>
                        </div>
					...
					$CI = get_instance();
						...
						<div class="form-group">
                              <div class="row">
								...
								<div class="col-md-4">	
							<?php  $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '".$doc->id."' AND table_id = '".$visitor->id."' AND form = '".$doc->form."' ")->row();?>		
					...
					?>	<div class="form-group">
                              <div class="row">
								...
								<div class="col-md-4">	
								<?php  $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '".$doc->id."' AND table_id = '".$visitor->id."'  ")->row();?>	
					...
					?>	<div class="form-group">
							...
							<?php 
							$x="";
							$result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '".$doc->id."' AND table_id = '".$visitor->id."' AND form = '".$doc->form."' ")->row();
