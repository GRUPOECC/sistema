...
<section class="content-header">
    <h1>
        <?php echo lang('dept');?> <?php echo lang('category');?>
        <small><?php echo lang('edit');?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin')?>"><i class="fa fa-dashboard"></i> <?php echo lang('dashboard');?></a></li>
        <li><a href="<?php echo site_url('admin/dept_category')?>"><?php echo lang('dept');?> <?php echo lang('category');?></a></li>
...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/dept_category/edit/'.$id); ?>
                    <div class="box-body">
